...
const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-900 font-sans flex flex-col pt-16">
                ...
                <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-8 min-h-[70vh]">
                    ...
                    <div className="flex-1 w-full relative drop-shadow-2xl hero-illustration-container flex justify-center lg:justify-end">
                        ...
                        <img
                            ...
                            alt="Student interacting with Hub"
            ...
            {/* Footer Section with Interactive Features */}
                ...
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
                    ...
                    <div className="lg:col-span-4 grid grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="flex flex-col items-start gap-4">
                            <div className="w-14 h-14 rounded-full bg-blue-500/20 text-blue-400 flex items-center justify-center text-2xl border border-blue-500/30">
                                <FaCalendarCheck />
                            </div>
                            <h4 className="text-white font-bold text-lg">Smart Bookings</h4>
                            <p className="text-sm text-slate-400 leading-relaxed">Reserve halls and equipment instantly with real-time sync.</p>
                        </div>

                        {/* Feature 2 */}
                        <div className="flex flex-col items-start gap-4">
                            <div className="w-14 h-14 rounded-full bg-orange-500/20 text-orange-400 flex items-center justify-center text-2xl border border-orange-500/30">
                                <FaBell />
                            </div>
                            <h4 className="text-white font-bold text-lg">Instant Alerts</h4>
                            <p className="text-sm text-slate-400 leading-relaxed">Never miss an update with targeted campus-wide notifications.</p>
                        </div>

                        {/* Feature 3: Integrated with your CreateTicket Page */}
                        <div
                            onClick={() => navigate('/create-ticket')}
                            className="flex flex-col items-start gap-4 cursor-pointer group hover:bg-slate-800 p-4 rounded-xl transition-all"
                        >
                            <div className="w-14 h-14 rounded-full bg-emerald-500/20 text-emerald-400 flex items-center justify-center text-2xl border border-emerald-500/30 group-hover:scale-110 transition-transform">
                                <FaTools />
                            </div>
                            <h4 className="text-white font-bold text-lg group-hover:text-emerald-400 transition-colors">Issue Reporting</h4>
                            <p className="text-sm text-slate-400 leading-relaxed">Log maintenance requests effortlessly with tracking.</p>
                        </div>

                        {/* Feature 4 */}
                        <div className="flex flex-col items-start gap-4">
                            <div className="w-14 h-14 rounded-full bg-purple-500/20 text-purple-400 flex items-center justify-center text-2xl border border-purple-500/30">
                                <FaChartLine />
                            </div>
                            <h4 className="text-white font-bold text-lg">Data Insights</h4>
                            <p className="text-sm text-slate-400 leading-relaxed">AI-driven analytics to optimize resource usage.</p>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-1 flex flex-col justify-center items-center lg:items-start text-center lg:text-left bg-slate-800/50 p-6 rounded-2xl border border-slate-700/50">
                        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 text-white flex items-center justify-center text-xl shadow-lg mb-4">
                            <FaHeadset />
                        </div>
                        <h4 className="text-white font-bold text-lg mb-2">Need Help?</h4>
                        <p className="text-sm text-slate-400 mb-6">24/7 support for all campus inquiries.</p>
