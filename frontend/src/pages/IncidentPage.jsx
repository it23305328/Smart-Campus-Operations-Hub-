...
import { 
    ...
    FaChevronRight, FaImages, FaFilePdf
} from 'react-icons/fa';
...
const IncidentPage = () => {
    ...
    const generatePDF = () => {
        ...
        doc.text("Incident Maintenance Report", 14, 30);
        
        doc.setFontSize(10);
        doc.text(`Generated on: ${new Date().toLocaleString()}`, 14, 38);
        doc.text(`Generated by: ${currentUser?.name || 'Admin'}`, 14, 44);
        if (searchTerm) {
            doc.text(`Search Filter: "${searchTerm}"`, 14, 50);
        }

        // Stats Summary (Based on Filtered Results)
        ...
        autoTable(doc, {
            startY: searchTerm ? 60 : 55,
            head: [['Statistic', 'Value']],
            body: [
                ['Results Found', filteredTickets.length],
        ...
        autoTable(doc, {
            ...
            head: [['ID', 'Title', 'Category', 'Priority', 'Status', 'Technician', 'Date']],
            body: tableData,
            styles: { fontSize: 8 },
        ...
        doc.save(`Campus_Maintenance_Report_${new Date().getTime()}.pdf`);
    };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4">
                    {currentUser?.role !== 'USER' && (
                        <button 
                            onClick={generatePDF}
                            className="bg-slate-800 text-white px-6 py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest shadow-xl shadow-slate-900/20 hover:bg-black transition-all hover:-translate-y-0.5 active:translate-y-0 flex items-center gap-2"
                        >
            ...
            <div className="mb-8 relative max-w-2xl">
                ...
                <input 
                    ...
                    className="w-full bg-white border-2 border-slate-100 rounded-[2rem] py-5 pl-16 pr-6 font-bold text-slate-700 placeholder:text-slate-300 focus:border-blue-500 focus:ring-4 focus:ring-blue-50 outline-none transition-all shadow-xl shadow-slate-900/5"
                />
                {searchTerm && (
                    <button 
                        onClick={() => setSearchTerm("")}
                        className="absolute right-6 top-1/2 -translate-y-1/2 text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-rose-500 transition-colors"
                    >
                        Clear
                    </button>
                )}
